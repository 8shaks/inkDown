    ...
    render() {
        return (
            <div className='services'>
                <h1 className='services-page-header'>What we do</h1>
              ...
              <a href='#'className='services-card' id='graphic-box'><div > Graphic Design<br/><span>Coming Soon</span></div></a>
                    ...
                    <p className='services-webDesign-para1'>At inkDown we make web development easy for you. We take care of everything, from getting your site to the top of google rankings to designing a website that showcases your business's talent and hard work. Our websites are always created with one purpose, to boost your sales and get you the perfect clients your looking for.</p>
