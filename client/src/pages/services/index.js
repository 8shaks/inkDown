...
export default class Services extends Component {
    render() {
        return (
            <Layout>
            <SEO title='About Us' description="A digital marketing agency focused on delivering websites, graphics, logos, and videos that provide results for our partners. Here's some more information about who we are and the services we provide."/>
